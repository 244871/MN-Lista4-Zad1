...
public class Bisection {
    ...
    public Bisection(ScalarFunction func) {
        this.func = func;
    }
    ...
    void solver(double xl, double xu, double dok, int maxIter) {
        ...
        for (int i = 0; i < maxIter; i++) {
            ...
            wyniki.add(new Wyniki(i, xl, oblicz(xl), xu, oblicz(xu),  dokladnosc(xl, xu), xr(xl, xu),
                    oblicz(xr(xl, xu)), bladT(xr(xl, xu)), bladA(xr(xl, xu), xstare)));
